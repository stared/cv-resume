...
\vspace{3mm}
    ...
    \begin{list2}
        \vspace*{-4mm}
        \item \href{http://trainings.deepsense.io/}{2-day intensive training in machine learning and big data for DeepSense.io} in San Francisco; New York and London scheduled (IPython Notebook, scikit-learn, Spark)

...
%\vspace{-2mm}
    ...
    Quantum Optics Theory Group, advisor: prof. Maciej Lewenstein \hfill { Feb 2011--Dec 2014}\\
   \begin{list2}
        \vspace*{-4mm}
        \item PhD thesis (submitted):\\
            Symmetries and self-similarity of many-body wavefunctions. \hfill {Sept 2014}
    \end{list2}
    \vspace*{-4mm}

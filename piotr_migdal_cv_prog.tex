...
%\vspace{-2mm}
   ...
   %  Objective
    ...
    A data scientist (data analysis and visualization), with scientific background in quantum optics. 
...
%\vspace{3mm}
    ...
    \item Freelancing: data analysis of schools for \href{http://projektpolska.pl/english/}{projekt:polska}, Warsaw, Poland  \hfill Jan -- Apr 2014\\
        Project: \href{http://szkolomat.pl/}{Szkolomat}. Data consultancy, data cleaning and merging, geocoding. 
...
%\vspace{-2mm}
    ...
    \begin{list2}
        ...
        \item Programming languages/technologies: Python, JavaScript, Mathematica, LaTeX, Gir
    \end{list2}
